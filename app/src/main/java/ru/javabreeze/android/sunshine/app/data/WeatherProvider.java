...
public class WeatherProvider extends ContentProvider {
    ...
    static final String TAG = "Weather Provider";
    ...
    public int update(
        ...
        switch (match) {
            case WEATHER: {
                normalizeDate(values);
                numOfRowsUpdated = db.update(WeatherContract.WeatherEntry.TABLE_NAME, values,
                        selection, selectionArgs);
                break;
            }
            case LOCATION: {
                numOfRowsUpdated = db.update(WeatherContract.LocationEntry.TABLE_NAME, values,
                        selection, selectionArgs);
                break;
            }
            default: throw new UnsupportedOperationException("Unknown uri: " + uri);
        ...
        if (numOfRowsUpdated != 0) getContext().getContentResolver().notifyChange(uri, null);
