package ru.javabreeze.android.sunshine.app.sync;
...
import ru.javabreeze.android.sunshine.app.Constants;
import ru.javabreeze.android.sunshine.app.MainActivity;
import ru.javabreeze.android.sunshine.app.R;
import ru.javabreeze.android.sunshine.app.Utility;
...
public class SunshineSyncAdapter extends AbstractThreadedSyncAdapter {
    ...
    private void getWeatherDataFromJson(String forecastJsonStr,
        ...
        try {
            ...
            if (cVVector.size() > 0) {
                ...
                ContentValues[] values = cVVector.toArray(new
            ...
            boolean isNotificationsOn = prefs.getBoolean(getContext().getString(R.string
                    .pref_notifications_key), false);
    ...
    private long addLocation(String locationSetting, String cityName,
        ...
        if (locationCursor.getCount() < 1) {
            ...
            long id = ContentUris.parseId(finalUri);
            return id;
        } else {
    ...
    private void notifyWeather() {
        ...
        if (System.currentTimeMillis() - lastSync >= DAY_IN_MILLIS) {
            ...
            if (cursor.moveToFirst()) {
                ...
                int iconId = Utility.getResourceConditionIcon(desc);
                ...
                NotificationCompat.Builder mBuilder =
                        new NotificationCompat.Builder(getContext())
                                .setSmallIcon(iconId)
                                .setContentTitle(getContext().getString(R.string
                                        .notification_title))
